...
/**
 *
 * NotORMStructureDiscovery.php
 *
 * Code Description
 *
 * @author     limin<lmin@vip.deyi.com>
 * @since      2015-11-17 20:20
 * @copyright  deyi.com
 *¡¡
 */
...
class NotORMStructureDiscovery implements InterfaceNotORMStructure
{
     ...
     */
    function __construct(\PDO $connection, NotORMCache $cache = null, $foreign = '%s') {
